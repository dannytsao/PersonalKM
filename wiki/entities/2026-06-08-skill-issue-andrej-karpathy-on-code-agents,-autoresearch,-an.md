...
2. 他指出當前AI研究與工程的進展使開發者能以宏觀行動操作軟體庫，但核心問題仍圍繞「技能」——即如何善用現有工具串聯出更高效率的開發流程。
