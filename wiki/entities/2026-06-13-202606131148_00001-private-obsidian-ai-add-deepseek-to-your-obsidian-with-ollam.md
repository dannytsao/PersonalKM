...
影片分三階段說明：安裝Obsidian Compiler、整合私有AI模型DeepSeek與Ollama，並透過嵌入模型技術提升AI對用戶筆記的查詢與分析能力。
