...
url: https://github.com/anthropics/claude-code/issues/33791
platform: web
...
summary: 此議題討論允許用戶在計劃模式與執行模式中配置不同的模型，以便在Max/Team Premium方案中更有效地使用Opus預算，將其用於高價值任務如規劃、架構和複雜除錯，而在簡單任務中使用Sonnet模型。
status: unread
---
